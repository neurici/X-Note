			...
			<div class="column editor-wrapper">
				...
				<div class="editor-menu-wrapper">
					<div class="editor-submenu-lock-wrapper">
						<button type="button" class="editor-menu-button relock-button">Schimbare Parolă</button>
						<button type="button" class="editor-menu-button lock-button">Setare Parolă</button>
						<button type="button" class="editor-menu-button unlock-button">Eliminare Parolă</button>
					</div>
					<div class="editor-submenu-share-wrapper">
						<button type="button" class="editor-menu-button public-button">Public</button>
						<button type="button" class="editor-menu-button private-button">Privat</button>
						<button type="button" class="editor-menu-button link-button">Copiere Link</button>
					</div>
					<button type="button" class="editor-menu-button main rename-button">Redenumire</button>
					<button type="button" class="editor-menu-button main submenu-lock-button">Blocare</button>
					<button type="button" class="editor-menu-button main submenu-share-button">Partajare</button>
					<button type="button" class="editor-menu-button main delete-button">Ștergere</button>
					<button type="button" class="editor-menu-button main copy-button">Copiere</button>
					<button type="button" class="editor-menu-button main raw-button">Date Brute</button>
					<button type="button" class="editor-menu-button main close-button">Închidere</button>
				</div>
			</div>
		</div>
