<?php
	...
	if($shared) {
		if($locked) {
			$title_text = "Specificați Parola";
			$body_content = '<div class="form-wrapper"><input type="password" class="password" placeholder="Parola..."><button type="button" class="submit">Afișare</button></div>';
		}
		else {
		...
		$title_text = "Eroare";
		$body_content = "Fie ați introdus un link nevalid, fie nota pe care încercați să o accesați este una privată.";
	}
